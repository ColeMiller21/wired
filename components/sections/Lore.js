      ...
      <FallInPlace delay={0.05}>
        <div className="w-[80%] lg:w-[70%] text-gray-300 flex flex-col gap-[1.5rem] font-ubuntu text-[1.25rem] mb-[100px]">
          <p className="lore-text leading-loose">
            ...
            Radovan has found a way to exist beyond his physical form. He is
            able to live in many organisms using digital space, which enables
            him to transfer his mind into the computer and control his victims
            like a virus.
          </p>
          <p className="lore-text leading-loose">
            ...
            powerful than ever before. He has also gathered supporters to aid
            him in his quest for eternal life. The man on his back is using a
            breathing machine, similar to a blacksmith&apos;s bellows, to keep
            the boss alive. This machine substitutes for Radovan&apos;s lungs,
            which no longer function.
          </p>
          <p className="lore-text leading-loose">
            The lore of Radovan creates a world where humans are no longer the
            only dominant species. The line between human and machine is
            blurred, and the boundaries of life and death are pushed to the
            limit. Radovan is a symbol of the ultimate desire for power and
            control. His mind is more powerful than his physical body, and he is
            willing to do anything to achieve his goal. As the story unfolds, we
            are left to wonder if Radovan will succeed in his quest for eternal
            life or if his madness will lead to his ultimate demise.
          </p>
        </div>
      </FallInPlace>
    </div>
